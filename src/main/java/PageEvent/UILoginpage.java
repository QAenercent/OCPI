...
public class UILoginpage extends BaseTest {
	...
	public void validationofeyebutton() throws IOException {
		try {
			...
			String pass = driver.findElement(By.xpath("//input[@placeholder='Enter your password']"))
					.getAttribute("value");
	...
	public void validateforgetpasswordlink() throws InterruptedException, IOException {
		try {
			WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
			wait.until(
					ExpectedConditions.elementToBeClickable(By.xpath("//p[@class='style_forgotPasswordPara__1XcgL']")));
	...
	public void registertextvalidation() throws IOException {
		String Text = driver.findElement(By.xpath("//span[normalize-space()='Want to become a Roaming Provider?']"))
				.getText();
	...
	public void registerherelinkvalidation() throws IOException, InterruptedException {
		String Register_link = driver
				.findElement(By.xpath("//span[@class='tp-underline tp-cursor-pointer tp-light-text']")).getText();
	...
	public void validateregisterheretext() throws IOException, InterruptedException {
		try {
			...
			wait.until(ExpectedConditions
					.elementToBeClickable(By.xpath("//span[@class='tp-underline tp-cursor-pointer tp-light-text']")));
			driver.findElement(By.xpath("//span[@class='tp-underline tp-cursor-pointer tp-light-text']")).click();
			Thread.sleep(3);
			String validate_text = driver.findElement(By.xpath("//h4[normalize-space()='Become a Roaming Provider']"))
					.getText();
